...
TeacherCodeSlide.prototype = {
  ...
  _updateEditorWithLastSendAndExecute: function() {
    ...
    if (this._editor.updateWithServerExecutionContext()) { this.executeCodeAt(this._sendResource, 'send'); this._editor._authorBar.updateAuthorNameWith(this._serverExecutionContext.author);   this._editor._authorBar.updateLastSendAttendeeNameWith('');}
  },  
