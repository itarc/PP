...
describe("AttendeeSlideShow KeyHandling", function() {
  ...
  it("should prevent default when key pressed on document", function() {
    ...
    expect(AttendeeSlideShow.prototype._preventDefaultKeys.calls.count()).toBe(0);

    __triggerKeyboardEvent(document, F5);

    expect(AttendeeSlideShow.prototype._preventDefaultKeys.calls.count()).toBe(2); // SHOULD BE 1 => TO REVIEW
  });
  ...
  it("should prevent default when key pressed in editor", function() {
    ...
    expect(AttendeeSlideShow.prototype._preventDefaultKeys.calls.count()).toBe(1);
  });  
